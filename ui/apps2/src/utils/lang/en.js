export default {
  ...
  vote:{
    ...
    Voted: "Voted",
    Check: "Selected",
    cancelChecked: "Cancel cancellation",
    toVote:'Go to vote',
    allVoteNum:'Total votes',
    Voters:'Voters',
    Number of voters: "total number",
    maxNum:'Select at most 3',
  },
  Voting rules: {
    Rule 1: '1. You can get the number of votes by making a market in DFS or depositing in DSS',
    Rule 2: '2. Change the market-making, access to DSS will automatically re-vote',
    Rule 3: '3. Real-time feedback of the voting results of the latest ranking',
    Rule 4: '4. Choose up to 3 voting options for each account',
    Rule 5: '5. You can modify and vote again at any time',
    Rule 6: "Market making: 1DFS = 0.5 votes",
    Rule 7: "Save as you go: 1 DFS = 1 vote",
